...
class _HomeState extends State<Home> {
 ...
 void _calculate()
 {
  ...
  {
    _infoText = "Levemente acima do peso do Peso ${imc.toStringAsPrecision(3)}";
  }
        ...
        child: Column(
          ...
          children:  [
            ...
            Padding(
              ...
              child: Container(
                height: 50.0,
                child: ElevatedButton(onPressed: _calculate, //<-- Função calcular 
                child: 
            ...
            Text (_infoText, // <- Variavei String Info
             textAlign: TextAlign.center,
